  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}>
        <Fragment>
          <Header headerName={state.params.data} />

          <View style={{margin: 30}}>
            <Text style={styles.buyTxt}>Let's do this!!!</Text>
          ...
          <View style={{margin: 30}}>
            <Text style={styles.chooseAmount}> Select Amount Units</Text>
          ...
          <View style={{alignItems: 'center', marginVertical: 40}}>
            <Text style={styles.chooseAmount}>
              {' '}
              Your total in naira is NGN {amountCounter}
            </Text>
          </View>
          <View
            style={{
            ...
            style={styles.buyBtn}>
              <AntDesign name="arrowdown" size={20} color={colors.whitesmoke} />
